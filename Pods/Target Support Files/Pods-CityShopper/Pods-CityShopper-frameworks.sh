...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-CityShopper/Bond.framework"
  install_framework "Pods-CityShopper/ConvenienceKit.framework"
  install_framework "Pods-CityShopper/FBSDKCoreKit.framework"
  install_framework "Pods-CityShopper/FBSDKLoginKit.framework"
